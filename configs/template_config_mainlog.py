...
equal_min_len = 4 # Minimal length to be matched in the matching phase [0, inf]
...
number_skipped_characters = 22 # Number of characters skipped at the beginning of the lines [0, inf]
